(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))c(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&c(a)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();const M="monthData",g={getRawData(){const o=localStorage.getItem(M);return o?JSON.parse(o):{}},saveData(o){const e=JSON.stringify(o);localStorage.setItem(M,e)},getMonthData(o){const e=this.getRawData();return e[o]?e[o]:{employees:[],projects:[]}}},R={"2026-4":{employees:[{id:"emp_1",name:"Jone",surname:"Dow",dob:"1995-03-10",position:"Senior",salary:5e3,assignments:[],vacations:[]}],projects:[{id:"proj_1",projectName:"Alpha Dashboard",companyName:"Google",budget:15e3,capacity:3}]}};let E=new Set,N=null,k="";function U(o,e){N=o,k=e;const n=document.getElementById("vacation-modal"),c=document.getElementById("vacation-modal-title"),t=document.getElementById("calendar-grid-container");if(!n||!t){console.error("❌ Элементы календаря не найдены в DOM");return}const s=e.split("-"),a=parseInt(s[0],10),i=parseInt(s[1],10),l=g.getMonthData(e).employees.find(d=>String(d.id)===String(o));if(l){c.textContent=`Availability for ${l.name}`;const d=l.vacations||[];E=new Set(d.map(Number))}else E=new Set;G(a,i,t),Y(n,a,i,t),n.classList.add("modal--open"),console.log(`📅 Календарь открыт для сотрудника ${o} на период ${e}`)}function G(o,e,n){n.innerHTML=J(o,e),W(o,e)}function J(o,e){const n=new Date(o,e+1,0).getDate();let c=new Date(o,e,1).getDay()-1;c<0&&(c=6);const t=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let s='<div class="calendar-grid">';t.forEach(a=>{s+=`<div class="calendar-header-cell ${a==="Sat"||a==="Sun"?"calendar-header-cell--weekend":""}">${a}</div>`});for(let a=0;a<c;a++)s+='<div class="calendar-day-cell calendar-day-cell--empty"></div>';for(let a=1;a<=n;a++){const r=new Date(o,e,a).getDay(),l=r===0||r===6;let d="calendar-day-cell calendar-day-target";l&&(d+=" calendar-day-cell--weekend"),E.has(a)&&(d+=" calendar-day-cell--selected"),s+=`<div class="${d}" data-day="${a}">${a}</div>`}return s+="</div>",s}function W(o,e){const n=new Date(o,e+1,0).getDate();let c=0,t=0;for(let l=1;l<=n;l++){const d=new Date(o,e,l).getDay();d===0||d===6||(c++,E.has(l)&&t++)}const s=c-t,a=document.getElementById("calendar-working-days");a&&(a.textContent=`Working Days: ${s}/${c} days`);const i=z(o,e),r=document.getElementById("calendar-vacation-ranges");r&&(r.textContent=i||"None")}function z(o,e){const n=Array.from(E).sort((i,r)=>i-r);if(n.length===0)return"";const c=[];let t=n[0],s=n[0];const a=i=>{const r=String(i).padStart(2,"0"),l=String(e+1).padStart(2,"0");return`${r}.${l}`};for(let i=1;i<n.length;i++){const r=n[i];let l=!1;if(r===s+1)l=!0;else{let d=!1;for(let p=s+1;p<r;p++){const m=new Date(o,e,p).getDay();if(m!==0&&m!==6){d=!0;break}}d||(l=!0)}l||(t===s?c.push(a(t)):c.push(`${a(t)}-${a(s)}`),t=r),s=r}return t===s?c.push(a(t)):c.push(`${a(t)}-${a(s)}`),c.join(", ")}function Y(o,e,n,c){c.onclick=function(s){const a=s.target;if(!a.classList.contains("calendar-day-target"))return;const i=parseInt(a.getAttribute("data-day"),10);E.has(i)?(E.delete(i),a.classList.remove("calendar-day-cell--selected")):(E.add(i),a.classList.add("calendar-day-cell--selected")),W(e,n)},o.onclick=function(s){(s.target.id==="vacation-modal-overlay"||s.target.id==="vacation-modal-close")&&(o.classList.remove("modal--open"),console.log("🔒 Календарь закрыт"))};const t=document.getElementById("btn-save-vacation");t&&(t.onclick=function(){const s=g.getRawData(),r=((s[k]||{}).employees||[]).find(l=>String(l.id)===String(N));r&&(r.vacations=Array.from(E).sort((l,d)=>l-d),g.saveData(s),console.log(`💾 Отпуска сохранены для сотрудника ${N}:`,r.vacations),v("employees",k),o.classList.remove("modal--open"))})}function X(o,e){const n=new Date(o,e+1,0).getDate();let c=0;for(let t=1;t<=n;t++){const s=new Date(o,e,t).getDay();s===0||s===6||c++}return c}function Z(o,e,n){if(!o||!Array.isArray(o)||o.length===0)return 0;let c=0;return o.forEach(t=>{const s=new Date(e,n,t).getDay();s===0||s===6||c++}),c}function B(o,e){const n=e.split("-"),c=parseInt(n[0],10),t=parseInt(n[1],10),s=X(c,t),a=o.vacations||[],i=Z(a,c,t);if(s===0)return 0;const r=i/s;return Math.round(r*100)/100}function A(o,e){const c=100*(1-B(o,e));return Math.round(c)}function S(o,e,n,c){const t=e.filter(function(l){return String(l.projectId)===String(o.id)});let s=0,a=0;t.forEach(function(l){const d=n.find(function(p){return String(p.id)===String(l.employeeId)});if(d){s+=l.capacity;const p=B(d,c),m=d.salary*(l.capacity/100)*(1-p);a+=m}});const i=o.budget,r=i-a;return{effectiveCapacity:Math.round(s),expenses:Math.round(a),revenue:Math.round(i),profit:Math.round(r)}}function Q(o,e,n,c){let t=0,s=0,a=0,i=0;return o.forEach(function(r){const l=S(r,e,n,c);t+=l.revenue,s+=l.effectiveCapacity,a+=l.expenses,i+=l.profit}),{totalBudget:t,totalCapacity:s,totalExpenses:a,totalProfit:i}}let y={projects:{companyName:"",projectName:""},employees:{name:"",surname:"",position:""},employeePosition:""};function H(o){const e=y[o];let n="",c=0;for(const t in e)if(e[t]&&e[t].trim()!==""){c++;const s=t.replace(/([A-Z])/g," $1").replace(/^./,a=>a.toUpperCase());n+=`
        ...
        `),`<div class="filter-chips-container">${n}</div>`}function j(o){return(Number(o)||0).toLocaleString("en-US",{minimumFractionDigits:2,minimumFractionDigits:2})+" $"}function K(o,e){if(!confirm("Are you sure you want to delete this project?"))return;const c=g.getMonthData(e),t=c.projects.filter(function(a){return a.id!==o});c.projects=t;const s=g.getRawData();s[e]=c,g.saveData(s),console.log(`❌ Проект с ID ${o} успешно удален`),v("projects",e)}function ee(o,e){const n=o.projects||[],c=o.assignments||[],t=o.employees||[],s=n.length,a=Q(n,c,t,e);return` 
    ...
    `}function te(o,e,n){let c=o.projects||[];const t=o.assignments||[],s=o.employees||[];if(y.projects.companyName&&y.projects.companyName.trim()!==""){const r=y.projects.companyName.toLowerCase().trim();c=c.filter(l=>l.companyName?l.companyName.toLowerCase().includes(r):!1)}if(y.projects.projectName&&y.projects.projectName.trim()!==""){const r=y.projects.projectName.toLowerCase().trim();c=c.filter(l=>l.projectName?l.projectName.toLowerCase().includes(r):!1)}n.tab==="projects"&&n.field&&(c=[...c].sort(function(r,l){let d,p;if(n.field==="expenses"||n.field==="profit"||n.field==="effectiveCapacity"){const m=S(r,t,s,e),f=S(l,t,s,e);d=m[n.field],p=f[n.field]}else d=r[n.field],p=l[n.field];return typeof d=="string"?n.direction==="asc"?d.localeCompare(p):p.localeCompare(d):n.direction==="asc"?d-p:p-d}));function a(r){return n.tab==="projects"&&n.field===r?n.direction==="asc"?" ↑":" ↓":""}let i=H("projects");return c.length===0?(i+='<p class="empty-state">No matching projects found</p>',i):(i+=` 
    <table class="table">
        <thead>
            <tr>
    ...
    `,c.forEach(function(r){const l=S(r,t,s,e),d=l.profit<0?"text-danger":"text-success";i+=`
        ...
        `}),i+="</tbody></table>",i)}function V(o,e){const n=document.getElementById("details-modal"),c=document.getElementById("details-modal-body"),t=document.getElementById("details-modal-title");if(!n||!c)return;typeof g.loadFromLocalStorage=="function"&&g.loadFromLocalStorage();const s=g.getMonthData(e),a=s.projects||[],i=s.employees||[],r=s.assignments||[],l=a.find(p=>p.id===o);l&&(t.textContent=`Team for "${l.projectName}"`);const d=r.filter(p=>String(p.projectId)===String(o));if(d.length===0)c.innerHTML='<p class="empty-state">No employees assigned to this project yet.</p>';else{let p='<ul class="team-list">';d.forEach(function(m){const f=i.find(b=>String(b.id)===String(m.employeeId));f&&(p+=`
                    <li class="team-item">
    ...
    `,t.forEach(function(i){const r=B(i,e),l=A(i,e),d=i.name?i.name.split(" "):["Unknown",""],p=d[0],m=d.slice(1).join(" ")||"—";a+=`
        ...
        `}),a+="</tbody></table>",setTimeout(()=>{const i=document.querySelector(".table");i&&!i.dataset.dblclickAssigned&&(i.dataset.dblclickAssigned="true",i.ondblclick=function(r){const l=r.target;if(l.classList.contains("editable")&&!l.querySelector("input")&&!l.querySelector("select")){let m=l.textContent.trim();b==="salary"&&(m=m.replace(/[^0-9.]/g,""));const f=l.getAttribute("data-id"),b=l.getAttribute("data-field");if(b==="position"){let I=function(){P(f,b,u.value,e,c)};var d=I;const u=document.createElement("select");u.className="table-inline-select",["Junior","Middle","Senior","Lead","Architect","BO"].forEach(D=>{const C=document.createElement("option");C.value=D,C.textContent=D,D.toLowerCase()===m.toLowerCase()&&(C.selected=!0),u.appendChild(C)}),l.innerHTML="",l.appendChild(u),u.focus(),u.onchange=I,u.onblur=I}else if(b==="salary"){let h=function(){P(f,b,u.value,e,c)};var p=h;const u=document.createElement("input");u.type="number",u.min="0",u.value=m,u.className="table-inline-input",l.innerHTML="",l.appendChild(u),u.focus(),u.onkeydown=I=>{I.key==="Enter"&&u.blur(),I.key==="Escape"&&(l.innerHTML=j(m))},u.onblur=h}}})},0),a)}const _={tab:null,field:null,direction:"asc"};function v(o,e){const n=document.getElementById("table-container");if(!n)return;const c=g.getMonthData(e);if(o==="projects"){const t=ee(c,e),s=te(c,e,_);n.innerHTML=t+s,n.onclick=function(a){if(a.target.classList.contains("sortable")){const l=a.target.getAttribute("data-sort");_.tab==="projects"&&_.field===l?_.direction=_.direction==="asc"?"desc":"asc":(_.tab="projects",_.field=l,_.direction="asc"),v("projects",e);return}if(a.target.classList.contains("filter-icon")){a.stopPropagation();const l=document.querySelector(".filter-popup");l&&l.remove();const d=a.target.getAttribute("data-filter-field"),p=a.target.closest("th"),m=document.createElement("div");m.className="filter-popup",m.innerHTML=`
