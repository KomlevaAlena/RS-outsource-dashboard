(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const T="monthData",g={getRawData(){const e=localStorage.getItem(T);return e?JSON.parse(e):{}},saveData(e){const t=JSON.stringify(e);localStorage.setItem(T,t)},getMonthData(e){const t=this.getRawData();return t[e]?t[e]:{employees:[],projects:[]}}},J={"2026-4":{employees:[{id:"emp_1",name:"Jone",surname:"Dow",dob:"1995-03-10",position:"Senior",salary:5e3,assignments:[],vacations:[]}],projects:[{id:"proj_1",projectName:"Alpha Dashboard",companyName:"Google",budget:15e3,capacity:3}]}};let D=new Set,k=null,N="";function Y(e,t){k=e,N=t;const o=document.getElementById("vacation-modal"),i=document.getElementById("vacation-modal-title"),n=document.getElementById("calendar-grid-container");if(!o||!n){console.error("❌ Элементы календаря не найдены в DOM");return}const s=t.split("-"),a=parseInt(s[0],10),c=parseInt(s[1],10),l=g.getMonthData(t).employees.find(d=>String(d.id)===String(e));if(l){i.textContent=`Availability for ${l.name}`;const d=l.vacations||[];D=new Set(d.map(Number))}else D=new Set;G(a,c,n),Z(o,a,c,n),o.classList.add("modal--open"),console.log(`📅 Календарь открыт для сотрудника ${e} на период ${t}`)}function G(e,t,o){o.innerHTML=z(e,t),R(e,t)}function z(e,t){const o=new Date(e,t+1,0).getDate();let i=new Date(e,t,1).getDay()-1;i<0&&(i=6);const n=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let s='<div class="calendar-grid">';n.forEach(a=>{s+=`<div class="calendar-header-cell ${a==="Sat"||a==="Sun"?"calendar-header-cell--weekend":""}">${a}</div>`});for(let a=0;a<i;a++)s+='<div class="calendar-day-cell calendar-day-cell--empty"></div>';for(let a=1;a<=o;a++){const r=new Date(e,t,a).getDay(),l=r===0||r===6;let d="calendar-day-cell calendar-day-target";l&&(d+=" calendar-day-cell--weekend"),D.has(a)&&(d+=" calendar-day-cell--selected"),s+=`<div class="${d}" data-day="${a}">${a}</div>`}return s+="</div>",s}function R(e,t){const o=new Date(e,t+1,0).getDate();let i=0,n=0;for(let l=1;l<=o;l++){const d=new Date(e,t,l).getDay();d===0||d===6||(i++,D.has(l)&&n++)}const s=i-n,a=document.getElementById("calendar-working-days");a&&(a.textContent=`Working Days: ${s}/${i} days`);const c=X(e,t),r=document.getElementById("calendar-vacation-ranges");r&&(r.textContent=c||"None")}function X(e,t){const o=Array.from(D).sort((c,r)=>c-r);if(o.length===0)return"";const i=[];let n=o[0],s=o[0];const a=c=>{const r=String(c).padStart(2,"0"),l=String(t+1).padStart(2,"0");return`${r}.${l}`};for(let c=1;c<o.length;c++){const r=o[c];let l=!1;if(r===s+1)l=!0;else{let d=!1;for(let m=s+1;m<r;m++){const u=new Date(e,t,m).getDay();if(u!==0&&u!==6){d=!0;break}}d||(l=!0)}l||(n===s?i.push(a(n)):i.push(`${a(n)}-${a(s)}`),n=r),s=r}return n===s?i.push(a(n)):i.push(`${a(n)}-${a(s)}`),i.join(", ")}function Z(e,t,o,i){i.onclick=function(s){const a=s.target;if(!a.classList.contains("calendar-day-target"))return;const c=parseInt(a.getAttribute("data-day"),10);D.has(c)?(D.delete(c),a.classList.remove("calendar-day-cell--selected")):(D.add(c),a.classList.add("calendar-day-cell--selected")),R(t,o)},e.onclick=function(s){(s.target.id==="vacation-modal-overlay"||s.target.id==="vacation-modal-close")&&(e.classList.remove("modal--open"),console.log("🔒 Календарь закрыт"))};const n=document.getElementById("btn-save-vacation");n&&(n.onclick=function(){const s=g.getRawData(),r=((s[N]||{}).employees||[]).find(l=>String(l.id)===String(k));r&&(r.vacations=Array.from(D).sort((l,d)=>l-d),g.saveData(s),console.log(`💾 Отпуска сохранены для сотрудника ${k}:`,r.vacations),_("employees",N),e.classList.remove("modal--open"))})}function Q(e,t){const o=new Date(e,t+1,0).getDate();let i=0;for(let n=1;n<=o;n++){const s=new Date(e,t,n).getDay();s===0||s===6||i++}return i}function K(e,t,o){if(!e||!Array.isArray(e)||e.length===0)return 0;let i=0;return e.forEach(n=>{const s=new Date(t,o,n).getDay();s===0||s===6||i++}),i}function L(e,t){const o=t.split("-"),i=parseInt(o[0],10),n=parseInt(o[1],10),s=Q(i,n),a=e.vacations||[],c=K(a,i,n);if(s===0)return 0;const r=c/s;return Math.round(r*100)/100}function A(e,t){const i=100*(1-L(e,t));return Math.round(i)}function w(e,t,o,i){const n=t.filter(function(l){return String(l.projectId)===String(e.id)});let s=0,a=0;n.forEach(function(l){const d=o.find(function(m){return String(m.id)===String(l.employeeId)});if(d){s+=l.capacity;const m=L(d,i),u=d.salary*(l.capacity/100)*(1-m);a+=u}});const c=e.budget,r=c-a;return{effectiveCapacity:Math.round(s),expenses:Math.round(a),revenue:Math.round(c),profit:Math.round(r)}}function ee(e,t,o,i){let n=0,s=0,a=0,c=0;return e.forEach(function(r){const l=w(r,t,o,i);n+=l.revenue,s+=l.effectiveCapacity,a+=l.expenses,c+=l.profit}),{totalBudget:n,totalCapacity:s,totalExpenses:a,totalProfit:c}}let y={projects:{companyName:"",projectName:""},employees:{name:"",surname:"",position:""},employeePosition:""};function V(e){const t=y[e];let o="",i=0;for(const n in t)if(t[n]&&t[n].trim()!==""){i++;const s=n.replace(/([A-Z])/g," $1").replace(/^./,a=>a.toUpperCase());o+=`
        ...
        `),`<div class="filter-chips-container">${o}</div>`}function B(e){return(Number(e)||0).toLocaleString("en-US",{minimumFractionDigits:2,minimumFractionDigits:2})+" $"}function te(e,t){if(!confirm("Are you sure you want to delete this project?"))return;const i=g.getMonthData(t),n=i.projects.filter(function(a){return a.id!==e});i.projects=n;const s=g.getRawData();s[t]=i,g.saveData(s),console.log(`❌ Проект с ID ${e} успешно удален`),_("projects",t)}function ae(e,t){const o=e.projects||[],i=e.assignments||[],n=e.employees||[],s=o.length,a=ee(o,i,n,t);return` 
    ...
    `}function ne(e,t,o){let i=e.projects||[];const n=e.assignments||[],s=e.employees||[];if(y.projects.companyName&&y.projects.companyName.trim()!==""){const r=y.projects.companyName.toLowerCase().trim();i=i.filter(l=>l.companyName?l.companyName.toLowerCase().includes(r):!1)}if(y.projects.projectName&&y.projects.projectName.trim()!==""){const r=y.projects.projectName.toLowerCase().trim();i=i.filter(l=>l.projectName?l.projectName.toLowerCase().includes(r):!1)}o.tab==="projects"&&o.field&&(i=[...i].sort(function(r,l){let d,m;if(o.field==="expenses"||o.field==="profit"||o.field==="effectiveCapacity"){const u=w(r,n,s,t),p=w(l,n,s,t);d=u[o.field],m=p[o.field]}else d=r[o.field],m=l[o.field];return typeof d=="string"?o.direction==="asc"?d.localeCompare(m):m.localeCompare(d):o.direction==="asc"?d-m:m-d}));function a(r){return o.tab==="projects"&&o.field===r?o.direction==="asc"?" ↑":" ↓":""}let c=V("projects");return i.length===0?(c+='<p class="empty-state">No matching projects found</p>',c):(c+=` 
    <table class="table">
        <thead>
            <tr>
...
`};class Ie{constructor(){console.log("🔄 SimpleComponentLoader создан"),this.loadedComponents=new Set}init(){console.log("🚀 Начинаю загрузку компонентов..."),this.loadAllComponents(),this.setupObserver(),console.log("✅ Все компоненты загружены")}loadAllComponents(){const t=document.querySelectorAll("[data-component]:not([data-loaded])");console.log(`📊 Найдено компонентов для загрузки: ${t.length}`),t.forEach(o=>{const i=o.getAttribute("data-component");this.loadComponent(o,i)})}loadComponent(t,o){console.log(`📥 Загружаю компонент: ${o}`),x[o]?(t.innerHTML=x[o],t.setAttribute("data-loaded","true"),this.loadedComponents.add(o),console.log(`✅ ${o} загружен`),this.loadAllComponents()):(console.error(`❌ Компонент "${o}" не найден в components.js`),t.innerHTML=`
      ...
      `)}setupObserver(){new MutationObserver(o=>{let i=!1;o.forEach(n=>{n.addedNodes.length&&n.addedNodes.forEach(s=>{s.nodeType===1&&s.querySelectorAll&&s.querySelectorAll("[data-component]").length>0&&(i=!0)})}),i&&(console.log("🔍 Обнаружены новые компоненты, загружаю..."),this.loadAllComponents())}).observe(document.body,{childList:!0,subtree:!0})}}document.addEventListener("DOMContentLoaded",()=>{new Ie().init()});console.log("🎯 Starting App...");console.log("✅ SCSS styles imported");const je=g.getRawData();Object.keys(je).length===0?(console.log("📦 Память пуста, записываю начальные данные..."),g.saveData(J)):console.log("📦 Данные уже есть в памяти, загружаю...");console.log("✅ Components loader imported");console.log("🚀 All modules loaded - waiting for components...");console.log("📦 Доступные компоненты:",Object.keys(x));console.log("📅 Данные за май 2026:",g.getMonthData("2026-4"));document.addEventListener("DOMContentLoaded",function(){setTimeout(function(){console.log("Инициализирую обработчики событий интерфейса..."),fe(),ye(),ve(),_e(),Ee()},0)});
