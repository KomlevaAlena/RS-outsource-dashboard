(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=o(n);fetch(n.href,s)}})();const M="monthData",g={getRawData(){const e=localStorage.getItem(M);return e?JSON.parse(e):{}},saveData(e){const t=JSON.stringify(e);localStorage.setItem(M,t)},getMonthData(e){const t=this.getRawData();return t[e]?t[e]:{employees:[],projects:[]}}},V={"2026-4":{employees:[{id:"emp_1",name:"Jone",surname:"Dow",dob:"1995-03-10",position:"Senior",salary:5e3,assignments:[],vacations:[]}],projects:[{id:"proj_1",projectName:"Alpha Dashboard",companyName:"Google",budget:15e3,capacity:3}]}};let D=new Set,A=null,N="";function U(e,t){A=e,N=t;const o=document.getElementById("vacation-modal"),i=document.getElementById("vacation-modal-title"),n=document.getElementById("calendar-grid-container");if(!o||!n){console.error("❌ Элементы календаря не найдены в DOM");return}const s=t.split("-"),a=parseInt(s[0],10),c=parseInt(s[1],10),l=g.getMonthData(t).employees.find(d=>String(d.id)===String(e));if(l){i.textContent=`Availability for ${l.name}`;const d=l.vacations||[];D=new Set(d.map(Number))}else D=new Set;J(a,c,n),G(o,a,c,n),o.classList.add("modal--open"),console.log(`📅 Календарь открыт для сотрудника ${e} на период ${t}`)}function J(e,t,o){o.innerHTML=z(e,t),W(e,t)}function z(e,t){const o=new Date(e,t+1,0).getDate();let i=new Date(e,t,1).getDay()-1;i<0&&(i=6);const n=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let s='<div class="calendar-grid">';n.forEach(a=>{s+=`<div class="calendar-header-cell ${a==="Sat"||a==="Sun"?"calendar-header-cell--weekend":""}">${a}</div>`});for(let a=0;a<i;a++)s+='<div class="calendar-day-cell calendar-day-cell--empty"></div>';for(let a=1;a<=o;a++){const r=new Date(e,t,a).getDay(),l=r===0||r===6;let d="calendar-day-cell calendar-day-target";l&&(d+=" calendar-day-cell--weekend"),D.has(a)&&(d+=" calendar-day-cell--selected"),s+=`<div class="${d}" data-day="${a}">${a}</div>`}return s+="</div>",s}function W(e,t){const o=new Date(e,t+1,0).getDate();let i=0,n=0;for(let l=1;l<=o;l++){const d=new Date(e,t,l).getDay();d===0||d===6||(i++,D.has(l)&&n++)}const s=i-n,a=document.getElementById("calendar-working-days");a&&(a.textContent=`Working Days: ${s}/${i} days`);const c=Y(e,t),r=document.getElementById("calendar-vacation-ranges");r&&(r.textContent=c||"None")}function Y(e,t){const o=Array.from(D).sort((c,r)=>c-r);if(o.length===0)return"";const i=[];let n=o[0],s=o[0];const a=c=>{const r=String(c).padStart(2,"0"),l=String(t+1).padStart(2,"0");return`${r}.${l}`};for(let c=1;c<o.length;c++){const r=o[c];let l=!1;if(r===s+1)l=!0;else{let d=!1;for(let p=s+1;p<r;p++){const u=new Date(e,t,p).getDay();if(u!==0&&u!==6){d=!0;break}}d||(l=!0)}l||(n===s?i.push(a(n)):i.push(`${a(n)}-${a(s)}`),n=r),s=r}return n===s?i.push(a(n)):i.push(`${a(n)}-${a(s)}`),i.join(", ")}function G(e,t,o,i){i.onclick=function(s){const a=s.target;if(!a.classList.contains("calendar-day-target"))return;const c=parseInt(a.getAttribute("data-day"),10);D.has(c)?(D.delete(c),a.classList.remove("calendar-day-cell--selected")):(D.add(c),a.classList.add("calendar-day-cell--selected")),W(t,o)},e.onclick=function(s){(s.target.id==="vacation-modal-overlay"||s.target.id==="vacation-modal-close")&&(e.classList.remove("modal--open"),console.log("🔒 Календарь закрыт"))};const n=document.getElementById("btn-save-vacation");n&&(n.onclick=function(){const s=g.getRawData(),r=((s[N]||{}).employees||[]).find(l=>String(l.id)===String(A));r&&(r.vacations=Array.from(D).sort((l,d)=>l-d),g.saveData(s),console.log(`💾 Отпуска сохранены для сотрудника ${A}:`,r.vacations),_("employees",N),e.classList.remove("modal--open"))})}function X(e,t){const o=new Date(e,t+1,0).getDate();let i=0;for(let n=1;n<=o;n++){const s=new Date(e,t,n).getDay();s===0||s===6||i++}return i}function Z(e,t,o){if(!e||!Array.isArray(e)||e.length===0)return 0;let i=0;return e.forEach(n=>{const s=new Date(t,o,n).getDay();s===0||s===6||i++}),i}function L(e,t){const o=t.split("-"),i=parseInt(o[0],10),n=parseInt(o[1],10),s=X(i,n),a=e.vacations||[],c=Z(a,i,n);if(s===0)return 0;const r=c/s;return Math.round(r*100)/100}function x(e,t){const i=100*(1-L(e,t));return Math.round(i)}function w(e,t,o,i){const n=t.filter(function(l){return String(l.projectId)===String(e.id)});let s=0,a=0;n.forEach(function(l){const d=o.find(function(p){return String(p.id)===String(l.employeeId)});if(d){s+=l.capacity;const p=L(d,i),u=d.salary*(l.capacity/100)*(1-p);a+=u}});const c=e.budget,r=c-a;return{effectiveCapacity:Math.round(s),expenses:Math.round(a),revenue:Math.round(c),profit:Math.round(r)}}function Q(e,t,o,i){let n=0,s=0,a=0,c=0;return e.forEach(function(r){const l=w(r,t,o,i);n+=l.revenue,s+=l.effectiveCapacity,a+=l.expenses,c+=l.profit}),{totalBudget:n,totalCapacity:s,totalExpenses:a,totalProfit:c}}let y={projects:{companyName:"",projectName:""},employees:{name:"",surname:"",position:""},employeePosition:""};function H(e){const t=y[e];let o="",i=0;for(const n in t)if(t[n]&&t[n].trim()!==""){i++;const s=n.replace(/([A-Z])/g," $1").replace(/^./,a=>a.toUpperCase());o+=`
    ...
    `}function te(e,t,o){let i=e.projects||[];const n=e.assignments||[],s=e.employees||[];if(y.projects.companyName&&y.projects.companyName.trim()!==""){const r=y.projects.companyName.toLowerCase().trim();i=i.filter(l=>l.companyName?l.companyName.toLowerCase().includes(r):!1)}if(y.projects.projectName&&y.projects.projectName.trim()!==""){const r=y.projects.projectName.toLowerCase().trim();i=i.filter(l=>l.projectName?l.projectName.toLowerCase().includes(r):!1)}o.tab==="projects"&&o.field&&(i=[...i].sort(function(r,l){let d,p;if(o.field==="expenses"||o.field==="profit"||o.field==="effectiveCapacity"){const u=w(r,n,s,t),m=w(l,n,s,t);d=u[o.field],p=m[o.field]}else d=r[o.field],p=l[o.field];return typeof d=="string"?o.direction==="asc"?d.localeCompare(p):p.localeCompare(d):o.direction==="asc"?d-p:p-d}));function a(r){return o.tab==="projects"&&o.field===r?o.direction==="asc"?" ↑":" ↓":""}let c=H("projects");return i.length===0?(c+='<p class="empty-state">No matching projects found</p>',c):(c+=` 
    <table class="table">
        <thead>
            <tr>
    ...
    `,i.forEach(function(r){const l=w(r,n,s,t),d=l.profit<0?"text-danger":"text-success";c+=`
        ...
        `}),c+="</tbody></table>",c)}function R(e,t){const o=document.getElementById("details-modal"),i=document.getElementById("details-modal-body"),n=document.getElementById("details-modal-title");if(!o||!i)return;typeof g.loadFromLocalStorage=="function"&&g.loadFromLocalStorage();const s=g.getMonthData(t),a=s.projects||[],c=s.employees||[],r=s.assignments||[],l=a.find(p=>p.id===e);l&&(n.textContent=`Team for "${l.projectName}"`);const d=r.filter(p=>String(p.projectId)===String(e));if(d.length===0)i.innerHTML='<p class="empty-state">No employees assigned to this project yet.</p>';else{let p='<ul class="team-list">';d.forEach(function(u){const m=c.find(b=>String(b.id)===String(u.employeeId));m&&(p+=`
                    <li class="team-item">
    ...
    <table class="table">
        ...
        <tbody>
    `,n.forEach(function(c){const r=L(c,t),l=x(c,t),d=c.name?c.name.split(" "):["Unknown",""],p=d[0],u=d.slice(1).join(" ")||"—";a+=`
            <tr>
                <td>${p}</td>
                <td>${u}</td>
