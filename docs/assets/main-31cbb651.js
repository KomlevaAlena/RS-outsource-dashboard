(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&c(a)}).observe(document,{childList:!0,subtree:!0});function o(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(e){if(e.ep)return;e.ep=!0;const s=o(e);fetch(e.href,s)}})();const M="monthData",u={getRawData(){const n=localStorage.getItem(M);return n?JSON.parse(n):{}},saveData(n){const t=JSON.stringify(n);localStorage.setItem(M,t)},getMonthData(n){const t=this.getRawData();return t[n]?t[n]:{employees:[],projects:[]}}},R={"2026-4":{employees:[{id:"emp_1",name:"Jone",surname:"Dow",dob:"1995-03-10",position:"Senior",salary:5e3,assignments:[],vacations:[]}],projects:[{id:"proj_1",projectName:"Alpha Dashboard",companyName:"Google",budget:15e3,capacity:3}]}};let E=new Set,N=null,k="";function U(n,t){N=n,k=t;const o=document.getElementById("vacation-modal"),c=document.getElementById("vacation-modal-title"),e=document.getElementById("calendar-grid-container");if(!o||!e){console.error("❌ Элементы календаря не найдены в DOM");return}const s=t.split("-"),a=parseInt(s[0],10),i=parseInt(s[1],10),l=u.getMonthData(t).employees.find(d=>String(d.id)===String(n));if(l){c.textContent=`Availability for ${l.name}`;const d=l.vacations||[];E=new Set(d.map(Number))}else E=new Set;G(a,i,e),Y(o,a,i,e),o.classList.add("modal--open"),console.log(`📅 Календарь открыт для сотрудника ${n} на период ${t}`)}function G(n,t,o){o.innerHTML=J(n,t),W(n,t)}function J(n,t){const o=new Date(n,t+1,0).getDate();let c=new Date(n,t,1).getDay()-1;c<0&&(c=6);const e=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"];let s='<div class="calendar-grid">';e.forEach(a=>{s+=`<div class="calendar-header-cell ${a==="Sat"||a==="Sun"?"calendar-header-cell--weekend":""}">${a}</div>`});for(let a=0;a<c;a++)s+='<div class="calendar-day-cell calendar-day-cell--empty"></div>';for(let a=1;a<=o;a++){const r=new Date(n,t,a).getDay(),l=r===0||r===6;let d="calendar-day-cell calendar-day-target";l&&(d+=" calendar-day-cell--weekend"),E.has(a)&&(d+=" calendar-day-cell--selected"),s+=`<div class="${d}" data-day="${a}">${a}</div>`}return s+="</div>",s}function W(n,t){const o=new Date(n,t+1,0).getDate();let c=0,e=0;for(let l=1;l<=o;l++){const d=new Date(n,t,l).getDay();d===0||d===6||(c++,E.has(l)&&e++)}const s=c-e,a=document.getElementById("calendar-working-days");a&&(a.textContent=`Working Days: ${s}/${c} days`);const i=z(n,t),r=document.getElementById("calendar-vacation-ranges");r&&(r.textContent=i||"None")}function z(n,t){const o=Array.from(E).sort((i,r)=>i-r);if(o.length===0)return"";const c=[];let e=o[0],s=o[0];const a=i=>{const r=String(i).padStart(2,"0"),l=String(t+1).padStart(2,"0");return`${r}.${l}`};for(let i=1;i<o.length;i++){const r=o[i];let l=!1;if(r===s+1)l=!0;else{let d=!1;for(let p=s+1;p<r;p++){const m=new Date(n,t,p).getDay();if(m!==0&&m!==6){d=!0;break}}d||(l=!0)}l||(e===s?c.push(a(e)):c.push(`${a(e)}-${a(s)}`),e=r),s=r}return e===s?c.push(a(e)):c.push(`${a(e)}-${a(s)}`),c.join(", ")}function Y(n,t,o,c){c.onclick=function(s){const a=s.target;if(!a.classList.contains("calendar-day-target"))return;const i=parseInt(a.getAttribute("data-day"),10);E.has(i)?(E.delete(i),a.classList.remove("calendar-day-cell--selected")):(E.add(i),a.classList.add("calendar-day-cell--selected")),W(t,o)},n.onclick=function(s){(s.target.id==="vacation-modal-overlay"||s.target.id==="vacation-modal-close")&&(n.classList.remove("modal--open"),console.log("🔒 Календарь закрыт"))};const e=document.getElementById("btn-save-vacation");e&&(e.onclick=function(){const s=u.getRawData(),r=((s[k]||{}).employees||[]).find(l=>String(l.id)===String(N));r&&(r.vacations=Array.from(E).sort((l,d)=>l-d),u.saveData(s),console.log(`💾 Отпуска сохранены для сотрудника ${N}:`,r.vacations),h("employees",k),n.classList.remove("modal--open"))})}function Z(n,t){const o=new Date(n,t+1,0).getDate();let c=0;for(let e=1;e<=o;e++){const s=new Date(n,t,e).getDay();s===0||s===6||c++}return c}function Q(n,t,o){if(!n||!Array.isArray(n)||n.length===0)return 0;let c=0;return n.forEach(e=>{const s=new Date(t,o,e).getDay();s===0||s===6||c++}),c}function D(n,t){const o=t.split("-"),c=parseInt(o[0],10),e=parseInt(o[1],10),s=Z(c,e),a=n.vacations||[],i=Q(a,c,e);if(s===0)return 0;const r=i/s;return Math.round(r*100)/100}function A(n,t){const c=100*(1-D(n,t));return Math.round(c)}function $(n,t,o,c){const e=t.filter(function(l){return String(l.projectId)===String(n.id)});let s=0,a=0;e.forEach(function(l){const d=o.find(function(p){return String(p.id)===String(l.employeeId)});if(d){s+=l.capacity;const p=D(d,c),m=d.salary*(l.capacity/100)*(1-p);a+=m}});const i=n.budget,r=i-a;return{effectiveCapacity:Math.round(s),expenses:Math.round(a),revenue:Math.round(i),profit:Math.round(r)}}function X(n,t,o,c){let e=0,s=0,a=0,i=0;return n.forEach(function(r){const l=$(r,t,o,c);e+=l.revenue,s+=l.effectiveCapacity,a+=l.expenses,i+=l.profit}),{totalBudget:e,totalCapacity:s,totalExpenses:a,totalProfit:i}}let g={projects:{companyName:"",projectName:""},employees:{name:"",surname:"",position:""},employeePosition:""};function H(n){const t=g[n];let o="",c=0;for(const e in t)if(t[e]&&t[e].trim()!==""){c++;const s=e.replace(/([A-Z])/g," $1").replace(/^./,a=>a.toUpperCase());o+=`
    ...
    <table class="table">
        ...
        <tbody>
    `,c.forEach(function(r){const l=$(r,e,s,t),d=l.profit<0?"text-danger":"text-success";i+=`
            <tr>
                <td>${r.companyName}</td>
                <td>${r.projectName}</td>
                <td>${I(r.budget)}</td>
                ...
                <td>${I(l.expenses)}</td>
                <td class="${d}"><strong>${I(l.profit)}</strong></td>
                <td>
    ...
    <table class="table">
        ...
        <tbody>
    `,e.forEach(function(i){const r=D(i,t),l=A(i,t),d=i.name?i.name.split(" "):["Unknown",""],p=d[0],m=d.slice(1).join(" ")||"—";a+=`
            <tr>
                <td>${p}</td>
                <td>${m}</td>
                <td class="editable" data-id="${i.id}" data-field="position">${i.position}</td>
                <td>${i.age} y.o.</td>
                <td class="editable" data-id="${i.id}" data-field="salary">${I(i.salary)}</td>
        ...
        `}),a+="</tbody></table>",setTimeout(()=>{const i=document.querySelector(".table");i&&!i.dataset.dblclickAssigned&&(i.dataset.dblclickAssigned="true",i.ondblclick=function(r){const l=r.target;if(l.classList.contains("editable")&&!l.querySelector("input")&&!l.querySelector("select")){let m=l.textContent.trim();v==="salary"&&(m=m.replace(/[^0-9.]/g,""));const y=l.getAttribute("data-id"),v=l.getAttribute("data-field");if(v==="position"){let _=function(){x(y,v,f.value,t,c)};var d=_;const f=document.createElement("select");f.className="table-inline-select",["Junior","Middle","Senior","Lead","Architect","BO"].forEach(S=>{const B=document.createElement("option");B.value=S,B.textContent=S,S.toLowerCase()===m.toLowerCase()&&(B.selected=!0),f.appendChild(B)}),l.innerHTML="",l.appendChild(f),f.focus(),f.onchange=_,f.onblur=_}else if(v==="salary"){let j=function(){x(y,v,f.value,t,c)};var p=j;const f=document.createElement("input");f.type="number",f.min="0",f.value=m,f.className="table-inline-input",l.innerHTML="",l.appendChild(f),f.focus(),f.onkeydown=_=>{_.key==="Enter"&&f.blur(),_.key==="Escape"&&(l.innerHTML=I(m))},f.onblur=j}}})},0),a)}const b={tab:null,field:null,direction:"asc"};function h(n,t){const o=document.getElementById("table-container");if(!o)return;const c=u.getMonthData(t);if(n==="projects"){const e=ee(c,t),s=te(c,t,b);o.innerHTML=e+s,o.onclick=function(a){if(a.target.classList.contains("sortable")){const l=a.target.getAttribute("data-sort");b.tab==="projects"&&b.field===l?b.direction=b.direction==="asc"?"desc":"asc":(b.tab="projects",b.field=l,b.direction="asc"),h("projects",t);return}if(a.target.classList.contains("filter-icon")){a.stopPropagation();const l=document.querySelector(".filter-popup");l&&l.remove();const d=a.target.getAttribute("data-filter-field"),p=a.target.closest("th"),m=document.createElement("div");m.className="filter-popup",m.innerHTML=`
                ...
                `,r.appendChild(l);const d=l.querySelector("#filter-popup-input");d.focus(),d.onkeydown=function(p){p.key==="Enter"&&l.querySelector("#filter-btn-apply").click()};return}if(e.target.id==="filter-btn-apply"){const a=e.target.getAttribute("data-field"),i=document.getElementById("filter-popup-input").value;g.employees[a]=i,h("employees",t);return}if(e.target.id==="filter-btn-cancel"){const a=e.target.closest(".filter-popup");a&&a.remove();return}if(e.target.classList.contains("filter-chip__remove")){const a=e.target.getAttribute("data-filter-key");g.employees[a]="",h("employees",t);return}if(e.target.classList.contains("filter-chip--clear-all")){g.employees.name="",g.employees.surname="",g.employees.position="",h("employees",t);return}const s=document.querySelector(".filter-popup");if(s&&!e.target.closest(".filter-popup")&&s.remove(),e.target.classList.contains("btn-availability")){const a=e.target.getAttribute("data-id");U(a,t)}if(e.target.classList.contains("btn-delete--emp")){const a=e.target.getAttribute("data-id");ne(a,t,()=>h("employees",t))}})}function P(){const n=document.getElementById("month-select"),t=document.getElementById("year-select");return!n||!t?"2026-01":t.value+"-"+n.value}function se(n){const t=document.querySelectorAll(".nav-button"),o=document.getElementById("page-title"),c=document.getElementById("add-entity-btn");t.forEach(function(i){i.classList.remove("nav-button--active")});const e=n.currentTarget;e.classList.add("nav-button--active");const s=e.getAttribute("data-tab");s==="projects"?(o.textContent="Projects",c&&(c.textContent="+ Add projects")):s==="employees"&&(o.textContent="Employees",c&&(c.textContent="+ Add employee")),console.log("Переключено на вкладку:",s);const a=P();h(s,a)}function T(){const n=document.querySelector(".nav-button--active"),t=n?n.getAttribute("data-tab"):"projects",o=P();h(t,o),console.log("Период изменен на:",o)}function le(){const n=document.getElementById("project-panel");n&&n.classList.add("slide-panel--open")}function q(){const n=document.getElementById("project-panel");n&&n.classList.remove("slide-panel--open")}function ie(){const n=document.getElementById("employee-panel");n&&n.classList.add("slide-panel--open")}function F(){const n=document.getElementById("employee-panel");n&&n.classList.remove("slide-panel--open")}function ce(){const n=document.getElementById("sidebar"),t=document.getElementById("sidebar-toggle"),o=document.querySelectorAll(".nav-button"),c=document.getElementById("month-select"),e=document.getElementById("year-select"),s=document.getElementById("add-entity-btn"),a=document.getElementById("project-panel-close"),i=document.getElementById("project-panel-overlay"),r=document.getElementById("employee-panel-close"),l=document.getElementById("employee-panel-overlay");if(!c||!e)return;const d=localStorage.getItem("app-selected-month"),p=localStorage.getItem("app-selected-year");d&&(c.value=d),p&&(e.value=p),c.addEventListener("change",function(){localStorage.setItem("app-selected-month",c.value),T()}),e.addEventListener("change",function(){localStorage.setItem("app-selected-year",e.value),T()}),n&&t&&t.addEventListener("click",function(){n.classList.toggle("sidebar--collapsed")}),o.forEach(function(v){v.addEventListener("click",se)}),s&&s.addEventListener("click",function(){const v=document.querySelector(".nav-button--active"),f=v?v.getAttribute("data-tab"):"projects";f==="projects"?le():f==="employees"&&ie()}),a&&a.addEventListener("click",q),i&&i.addEventListener("click",q),r&&r.addEventListener("click",F),l&&l.addEventListener("click",F);const m=document.querySelector(".nav-button--active"),y=m?m.getAttribute("data-tab"):"projects";h(y,P())}function C(){const n=document.getElementById("proj-name"),t=document.getElementById("proj-company"),o=document.getElementById("proj-budget"),c=document.getElementById("proj-capacity"),e=document.getElementById("proj-submit"),s=n.value.trim().length>0,a=t.value.trim().length>0,i=Number(o.value)>0,r=Number(c.value)>0;s&&a&&i&&r?e.disabled=!1:e.disabled=!0}function re(n){n.preventDefault();const t=document.getElementById("proj-name"),o=document.getElementById("proj-company"),c=document.getElementById("proj-budget"),e=document.getElementById("proj-capacity"),s=document.getElementById("month-select"),i=document.getElementById("year-select").value+"-"+s.value,l={id:"proj_"+Date.now(),projectName:t.value.trim(),companyName:o.value.trim(),budget:Number(c.value),capacity:Number(e.value)},d=u.getMonthData(i);d.projects.push(l);const p=u.getRawData();p[i]=d,u.saveData(p),console.log("✅ Новый проект успешно сохранен в Store:",l),h("projects",i),document.getElementById("project-form").reset(),document.getElementById("proj-submit").disabled=!0;const m=document.getElementById("project-panel");m&&m.classList.remove("slide-panel--open")}function de(){const n=document.getElementById("project-form");if(n){const t=document.getElementById("proj-name"),o=document.getElementById("proj-company"),c=document.getElementById("proj-budget"),e=document.getElementById("proj-capacity");t.addEventListener("input",C),o.addEventListener("input",C),c.addEventListener("input",C),e.addEventListener("input",C),n.addEventListener("submit",re)}}function L(){const n=document.getElementById("emp-name"),t=document.getElementById("emp-position"),o=document.getElementById("emp-age"),c=document.getElementById("emp-salary"),e=document.getElementById("emp-submit"),s=document.getElementById("error-emp-age"),a=n.value.trim().length>0,i=t.value.trim().length>0,r=Number(c.value)>0,l=Number(o.value);let d=!1;o.value.trim()===""?s.textContent="":l<18?s.textContent="The employee must be over 18 years of age":(s.textContent="",d=!0),a&&i&&d&&r?e.disabled=!1:e.disabled=!0}function pe(n){n.preventDefault();const t=document.getElementById("emp-name"),o=document.getElementById("emp-position"),c=document.getElementById("emp-age"),e=document.getElementById("emp-salary"),s=document.getElementById("month-select"),i=document.getElementById("year-select").value+"-"+s.value,r={id:"emp_"+Date.now(),name:t.value.trim(),position:o.value.trim(),age:Number(c.value),salary:Number(e.value)},l=u.getMonthData(i);l.employees.push(r);const d=u.getRawData();d[i]=l,u.saveData(d),console.log("✅ Новый сотрудник добавлен:",r),h("employees",i),document.getElementById("employee-form").reset(),document.getElementById("emp-submit").disabled=!0;const p=document.getElementById("employee-panel");p&&p.classList.remove("slide-panel--open")}function me(){const n=document.getElementById("employee-form");if(n){const t=document.getElementById("emp-name"),o=document.getElementById("emp-position"),c=document.getElementById("emp-age"),e=document.getElementById("emp-salary");t.addEventListener("input",L),o.addEventListener("input",L),c.addEventListener("input",L),e.addEventListener("input",L),n.addEventListener("submit",pe)}}function O(){const n=document.getElementById("assign-modal");n&&n.classList.remove("modal--open")}function ue(){const n=document.getElementById("assign-modal"),t=document.getElementById("assign-capacity-range"),o=document.getElementById("assign-range-value"),c=document.getElementById("assign-form");if(!n)return;n.onclick=function(s){(s.target.id==="assign-modal-overlay"||s.target.id==="assign-modal-close")&&(console.log("🔒 Закрываем модальное окно..."),O())},t&&o&&(t.oninput=function(){o.textContent=t.value}),c&&(c.onsubmit=function(s){s.preventDefault();const a=document.getElementById("assign-project-id").value,i=document.getElementById("assign-emp-select").value,r=Number(t.value),l=document.getElementById("month-select"),p=document.getElementById("year-select").value+"-"+l.value;if(console.log("✏️ СОХРАНЯЕМ НАЗНАЧЕНИЕ. Ключ периода:",p),!i){alert("Please select an employee first!");return}const m=u.getMonthData(p);m.assignments||(m.assignments=[]);const y=m.assignments.find(function(f){return String(f.projectId)===String(a)&&String(f.employeeId)===String(i)});if(y)console.log("🔄 Сотрудник уже на проекте. Обновляем capacity с",y.capacity,"на",r),y.capacity=r;else{const f={projectId:a,employeeId:i,capacity:r};m.assignments.push(f),console.log("🔗 Новое назначение добавлено в Стор:",f)}const v=u.getRawData();v[p]=m,u.saveData(v),alert("Employee successfully assigned to the project!"),O(),renderCurrentTab("projects",p)});const e=document.getElementById("details-modal");e&&(e.onclick=function(s){(s.target.id==="details-modal-overlay"||s.target.id==="details-modal-close")&&e.classList.remove("modal--open")})}const w={"dashboard-app":`
...
`};class fe{constructor(){console.log("🔄 SimpleComponentLoader создан"),this.loadedComponents=new Set}init(){console.log("🚀 Начинаю загрузку компонентов..."),this.loadAllComponents(),this.setupObserver(),console.log("✅ Все компоненты загружены")}loadAllComponents(){const t=document.querySelectorAll("[data-component]:not([data-loaded])");console.log(`📊 Найдено компонентов для загрузки: ${t.length}`),t.forEach(o=>{const c=o.getAttribute("data-component");this.loadComponent(o,c)})}loadComponent(t,o){console.log(`📥 Загружаю компонент: ${o}`),w[o]?(t.innerHTML=w[o],t.setAttribute("data-loaded","true"),this.loadedComponents.add(o),console.log(`✅ ${o} загружен`),this.loadAllComponents()):(console.error(`❌ Компонент "${o}" не найден в components.js`),t.innerHTML=`
      ...
      `)}setupObserver(){new MutationObserver(o=>{let c=!1;o.forEach(e=>{e.addedNodes.length&&e.addedNodes.forEach(s=>{s.nodeType===1&&s.querySelectorAll&&s.querySelectorAll("[data-component]").length>0&&(c=!0)})}),c&&(console.log("🔍 Обнаружены новые компоненты, загружаю..."),this.loadAllComponents())}).observe(document.body,{childList:!0,subtree:!0})}}document.addEventListener("DOMContentLoaded",()=>{new fe().init()});console.log("🎯 Starting App...");console.log("✅ SCSS styles imported");const ge=u.getRawData();Object.keys(ge).length===0?(console.log("📦 Память пуста, записываю начальные данные..."),u.saveData(R)):console.log("📦 Данные уже есть в памяти, загружаю...");console.log("✅ Components loader imported");console.log("🚀 All modules loaded - waiting for components...");console.log("📦 Доступные компоненты:",Object.keys(w));console.log("📅 Данные за май 2026:",u.getMonthData("2026-4"));document.addEventListener("DOMContentLoaded",function(){setTimeout(function(){console.log("Инициализирую обработчики событий интерфейса..."),ce(),de(),me(),ue()},0)});
